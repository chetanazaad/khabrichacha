...
class ResearchStatistics(BaseModel):
    ...
    # Populated whenever the quality-gate escalates a strategy to a more
    # thorough one -- previously this happened completely silently, so
    # there was no way to tell from the UI/report that it had occurred at
    # all, let alone why.
